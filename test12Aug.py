...
if(len(le_new.classes_) == 2): 
   b=((data['label_name']== le_new.classes_[0]) | (data['label_name']== le_new.classes_[1]))
   data=data[b]
else:
     b=((data['label_name']== le_new.classes_[0]) | (data['label_name']== le_new.classes_[1]) | (data['label_name']== le_new.classes_[2]) )
     data=data[b]
